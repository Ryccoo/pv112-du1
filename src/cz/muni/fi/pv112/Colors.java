...
public class Colors
{
    ...
    public static final float cyan[] = {0.0f, 1.0f, 1.0f, 0.0f};
    public static final float magenta[] = {1.0f, 0.0f, 1.0f, 0.0f};
    public static final float yellow[] = {1.0f, 1.0f, 0.0f, 0.0f};
    public static final float white[] = {1.0f, 1.0f, 1.0f, 0.0f};
    public static final float red2[] = {0.5f, 0.0f, 0.0f, 0.0f};
    public static final float green2[] = {0.0f, 0.5f, 0.0f, 0.0f};
    public static final float blue2[] = {0.0f, 0.0f, 0.5f, 0.0f};
    public static final float cyan2[]	= {0.0f, 0.5f, 0.5f, 0.0f};
